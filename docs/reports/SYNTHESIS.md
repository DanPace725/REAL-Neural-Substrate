...
The name REAL stands for the endogenous learning loop at the heart of the system: **R**ecognize, **E**valuate, **A**ct, **L**earn. The current codebase represents Phase 8 of a multi-phase research trajectory. Earlier phases (4 through 7) progressively formalized the core engine, developed reusable interfaces, and demonstrated persistent substrate carryover. Phase 8 is the convergence point where all of that prior work is combined into a fully multi-agent "native substrate" architecture.
