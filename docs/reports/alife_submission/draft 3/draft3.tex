...
against 3.9 for cold start, confirming that the maintained substrate is the
primary knowledge carrier.
...
readability was the primary tool by which failure modes were diagnosed and
...
primary development methodology, as the experimental record documents.
...
23$\times$ improvement, establishing that the failure was entirely in the
evaluation harness.
...
The 3-seed mean carryover F1 of 0.936 approaches the MLP baseline of 0.963 (gap:
0.027; best seed gap: 0.011), achieved on fewer training examples than the MLP
(926 vs 1,072) and under a fundamentally different evaluation regime. The
